"""
unet.py from consistency model (Song et al., 2023)
https://github.com/openai/consistency_models/blob/main/cm/unet.py
"""
...
class QKVAttentionLegacy(nn.Module):
    ...
    def forward(self, qkv):
        ...
        # see https://github.com/openai/consistency_models/issues/56
        # a = a.float()
